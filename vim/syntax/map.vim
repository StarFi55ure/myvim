...
syn keyword mapDefine       CLASS END ENV FEATURE JOIN LABEL LAYER LEADER LEGEND MAP MAPS METADATA OUTPUTFORMAT
syn keyword mapDefine       PATTERN PLUGINS POINTS PROJECTION QUERYMAP REFERENCE SCALEBAR STYLE SYMBOL VALIDATION WEB
