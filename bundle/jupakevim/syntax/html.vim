...
syn region  htmlEndTag             matchgroup=htmlTagDelimiter start=+</+      end=+>+ contains=htmlTagN,htmlTagError
syn region  htmlTag                matchgroup=htmlTagDelimiter start=+<[^/]+   end=+>+ contains=htmlTagN,htmlString,htmlArg,htmlValue,htmlTagError,htmlEvent,htmlCssDefinition,@htmlPreproc,@htmlArgCluster
...
if version >= 508 || !exists("did_html_syn_inits")
  ...
  hi htmlTagDelimiter               ctermfg=red guifg=red
endif
